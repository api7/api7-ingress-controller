...
// pluginConfigProvider and pluginConfigUpdater are this file's own stubs. Upstream
...
func (p *pluginConfigProvider) Register(string, *http.ServeMux) {}

func (p *pluginConfigProvider) Update(context.Context, *provider.TranslateContext, client.Object) error {
	p.updated++
	return nil
}

func (p *pluginConfigProvider) Delete(_ context.Context, obj client.Object) error {
	p.deleted = append(p.deleted, k8stypes.NamespacedName{Namespace: obj.GetNamespace(), Name: obj.GetName()})
	return p.deleteErr
}

func (p *pluginConfigProvider) Start(context.Context) error { return nil }

func (p *pluginConfigProvider) NeedLeaderElection() bool { return true }

type pluginConfigUpdater struct {
	updates []status.Update
}

func (u *pluginConfigUpdater) Update(update status.Update) { u.updates = append(u.updates, update) }
...
) (*ApisixRouteReconciler, *pluginConfigProvider) {
	t.Helper()
...
func newIngressPluginConfigFixture(
	...
	interceptorFuncs interceptor.Funcs,
	extraObjects ...client.Object,
) (*IngressReconciler, *pluginConfigProvider) {
	t.Helper()
