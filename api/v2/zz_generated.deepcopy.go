...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApisixGlobalRuleStatus) DeepCopyInto(out *ApisixGlobalRuleStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApisixGlobalRuleStatus.
func (in *ApisixGlobalRuleStatus) DeepCopy() *ApisixGlobalRuleStatus {
	if in == nil {
		return nil
	}
	out := new(ApisixGlobalRuleStatus)
	in.DeepCopyInto(out)
	return out
}
