...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPRoutePolicySpecPolicy) DeepCopyInto(out *HTTPRoutePolicySpecPolicy) {
	*out = *in
	if in.Priority != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPRoutePolicySpecPolicy.
func (in *HTTPRoutePolicySpecPolicy) DeepCopy() *HTTPRoutePolicySpecPolicy {
	if in == nil {
		return nil
	}
	out := new(HTTPRoutePolicySpecPolicy)
	in.DeepCopyInto(out)
	return out
}
