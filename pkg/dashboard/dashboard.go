...
type StreamRoute interface {
	...
	Create(ctx context.Context, route *v1.StreamRoute) (*v1.StreamRoute, error)
	Delete(ctx context.Context, route *v1.StreamRoute) error
	Update(ctx context.Context, route *v1.StreamRoute) (*v1.StreamRoute, error)
}
...
type GlobalRule interface {
	...
	Create(ctx context.Context, rule *v1.GlobalRule) (*v1.GlobalRule, error)
	Delete(ctx context.Context, rule *v1.GlobalRule) error
	Update(ctx context.Context, rule *v1.GlobalRule) (*v1.GlobalRule, error)
}
...
type Consumer interface {
	...
	Create(ctx context.Context, consumer *v1.Consumer) (*v1.Consumer, error)
	Delete(ctx context.Context, consumer *v1.Consumer) error
	Update(ctx context.Context, consumer *v1.Consumer) (*v1.Consumer, error)
}
...
type PluginConfig interface {
	...
	Create(ctx context.Context, plugin *v1.PluginConfig) (*v1.PluginConfig, error)
	Delete(ctx context.Context, plugin *v1.PluginConfig) error
	Update(ctx context.Context, plugin *v1.PluginConfig) (*v1.PluginConfig, error)
}
...
type PluginMetadata interface {
	...
	Update(ctx context.Context, metadata *v1.PluginMetadata) (*v1.PluginMetadata, error)
	Create(ctx context.Context, metadata *v1.PluginMetadata) (*v1.PluginMetadata, error)
}
...
func NewClient() (Dashboard, error) {
	cli := &apisix{
