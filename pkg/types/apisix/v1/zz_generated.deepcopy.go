...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpstreamNew) DeepCopyInto(out *UpstreamNew) {
	*out = *in
	in.Metadata.DeepCopyInto(&out.Metadata)
	if in.Checks != nil {
...
func (in *UpstreamNew) DeepCopy() *UpstreamNew {
	if in == nil {
		return nil
	}
	out := new(UpstreamNew)
...
func (in *UpstreamServiceRelation) DeepCopyInto(out *UpstreamServiceRelation) {
	*out = *in
	if in.UpstreamNames != nil {
		in, out := &in.UpstreamNames, &out.UpstreamNames
