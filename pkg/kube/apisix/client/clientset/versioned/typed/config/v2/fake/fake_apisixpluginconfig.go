...
var apisixpluginconfigsResource = v2.SchemeGroupVersion.WithResource("apisixpluginconfigs")

var apisixpluginconfigsKind = v2.SchemeGroupVersion.WithKind("ApisixPluginConfig")
