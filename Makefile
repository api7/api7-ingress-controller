...
test-e2e: kind-up kind-load-images ## Run the e2e tests against a Kind k8s instance that is spun up.
...
kind-load-images: pull-infra-images
	...
	@kind load docker-image hkccr.ccs.tencentyun.com/api7-dev/api7-ee-dp-manager:v3.2.14.2 --name $(KIND_NAME) 
	@kind load docker-image hkccr.ccs.tencentyun.com/api7-dev/api7-ee-3-integrated:v3.2.14.2 --name $(KIND_NAME) 
...
pull-infra-images:
	...
	@docker pull hkccr.ccs.tencentyun.com/api7-dev/api7-ee-dp-manager:v3.2.14.2
	@docker pull hkccr.ccs.tencentyun.com/api7-dev/api7-ee-3-integrated:v3.2.14.2
