...
require (
	...
	github.com/api7/api7-ingress-controller/test/e2e/testbackend v0.0.0
...
replace github.com/api7/api7-ingress-controller => ../../

replace github.com/api7/api7-ingress-controller/test/e2e/testbackend => ./testbackend
