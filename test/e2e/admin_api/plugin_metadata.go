...
import (
	...
	"github.com/api7/api7-ingress/test/e2e/scaffold"
...
var _ = Describe("Test Dashboard admin-api sdk", func() {
	...
	Context("Service and Route", func() {
		...
		It("Test service and route", func() {
			...
			s.DefaultDataplaneResource().Route().Delete(context.Background(), routeDefault)
			s.DefaultDataplaneResource().Route().Delete(context.Background(), routeAnything)
			s.DefaultDataplaneResource().Service().Delete(context.Background(), serviceDefault)
	...
	Context("Test Plugin metadata", func() {
		It("Update plugin meatadata", func() {
			...
			s.DefaultDataplaneResource().PluginMetadata().Update(context.Background(), datadog)
			...
			s.DefaultDataplaneResource().PluginMetadata().Update(context.Background(), updated)
