...
1. Clone the repository and check out the release to reproduce
   ...
   ```shell
   git clone https://github.com/api7/api7-ingress-controller.git && cd api7-ingress-controller
...
5. Run the suite
   ...
   The API7 EE data plane has its own target, which already declares the
   `api7ee` mode:
